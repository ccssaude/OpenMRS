...
and 
   ...
   and   (
              ...
              ( datediff(data_fim_tpi,data_inicio_tpi ) < 180 ) 
               ...
               or
                (data_inicio_tpi is not null and data_fim_tpi is  null)

              )

) elegiveis_tpi where NID in ('0111010801/2018/00315','0111011101/2020/00284','0111011101/2020/00334','0111011101/2020/00411')   group by patient_id order by curso_normal_tpi_fim desc