				...
				(  SELECT   patient_id , max(data_ult_carga)  data_ult_carga , valor_cv
                    ...
                    (  
						   SELECT 	e.patient_id,
							...
							FROM 	encounter e
									inner join obs o on e.encounter_id=o.encounter_id
							where 	e.encounter_type in (13,6,9) and e.voided=0 and encounter_datetime between date_sub(@endDate, interval 18 MONTH) and @endDate  
				    ...
				    UNION ALL
							...
							FROM 	encounter e
									inner join obs o on e.encounter_id=o.encounter_id
							where 	e.encounter_type = 53 and e.voided=0 and o.voided=0 and obs_datetime between date_sub(@endDate, interval 18 MONTH) and @endDate  
...
/****************************************************************************/
	WHERE
          ...
          or 
          ( cv.data_ult_cv is not null and cv.data_ult_cv <  inicio_real.date_enrolled ) 
